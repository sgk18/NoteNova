...
const seedUsers = [
  { name: "DK", email: "dk@notenova.com", password: "dk2007", college: "Christ University", department: "CSE", semester: "6", points: 45, role: "admin" },
    ...
    if (currentCount === 0) {
      for (let i = 0; i < seedResources.length; i++) {
        await Resource.create({
          ...
          fileUrl: "https://placeholder.notenova.com/seed",
        });
      }
    }
  }
